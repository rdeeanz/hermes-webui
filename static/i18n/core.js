...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_push: 'Push notifications (works when the app is closed)',
    settings_desc_push: 'Delivers a notification even when the browser is closed — when a turn finishes, or when the agent is waiting for your approval.',
    push_test_btn: 'Send test push',
    push_ios_hint: 'On iPhone and iPad, push only works after you add Hermes to the Home Screen — Safari tabs cannot receive it.',
    push_active: 'Active on this device.',
    push_unsupported: 'Push is not supported in this browser.',
    push_needs_https: 'Push requires HTTPS (or localhost).',
    push_permission_denied: 'Notification permission denied.',
    push_no_service_worker: 'Service worker unavailable.',
    push_server_unavailable: 'Server could not provide a push key.',
    push_test_sent: 'Test push sent.',
    push_test_failed: 'Test push failed.',
...
const LOCALE_MANIFEST = {
  ...
  zh: { label: '\u7b80\u4f53\u4e2d\u6587', speech: 'zh-CN' },
  'zh-Hant': { label: '繁體中文', speech: 'zh-TW' },
  pt: { label: 'Português', speech: 'pt-BR' },
  ko: { label: '한국어', speech: 'ko-KR' },
  fr: { label: 'Français', speech: 'fr-FR' },
  cs: { label: 'Čeština', speech: 'cs-CZ' },
  tr: { label: 'Türkçe', speech: 'tr-TR' },
  pl: { label: 'Polski', speech: 'pl-PL' },
  id: { label: 'Bahasa Indonesia', speech: 'id-ID' },
  vi: { label: 'Tiếng Việt', speech: 'vi-VN' },
};
