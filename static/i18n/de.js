...
// ─────────────────────────────────────────────────────────────────────────────
// de — loaded on demand by the loader in index.html.
LOCALES['de'] = {
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_push: 'Push-Benachrichtigungen (auch bei geschlossener App)',
    settings_desc_push: 'Benachrichtigt auch bei geschlossenem Browser — wenn ein Zug fertig ist oder der Agent auf deine Freigabe wartet.',
    push_test_btn: 'Test-Push senden',
    push_ios_hint: 'Auf iPhone und iPad funktioniert Push erst, wenn Hermes zum Home-Bildschirm hinzugefügt wurde — Safari-Tabs können ihn nicht empfangen.',
    push_active: 'Auf diesem Gerät aktiv.',
    push_unsupported: 'Push wird von diesem Browser nicht unterstützt.',
    push_needs_https: 'Push erfordert HTTPS (oder localhost).',
    push_permission_denied: 'Benachrichtigungsberechtigung verweigert.',
    push_no_service_worker: 'Service Worker nicht verfügbar.',
    push_server_unavailable: 'Server konnte keinen Push-Schlüssel liefern.',
    push_test_sent: 'Test-Push gesendet.',
    push_test_failed: 'Test-Push fehlgeschlagen.',
