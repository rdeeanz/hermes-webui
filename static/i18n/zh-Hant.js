...
// ─────────────────────────────────────────────────────────────────────────────
// zh-Hant — loaded on demand by the loader in index.html.
LOCALES['zh-Hant'] = {
    ...
    settings_label_push: '推播通知（應用程式關閉時也能收到）',
    settings_desc_push: '即使瀏覽器已關閉也會通知你 — 回合完成時，或代理等待你核准時。',
    push_test_btn: '傳送測試推播',
    push_ios_hint: '在 iPhone 與 iPad 上，需先將 Hermes 加入主畫面，推播才能運作 — Safari 分頁無法接收。',
    push_active: '已在此裝置上啟用。',
    push_unsupported: '此瀏覽器不支援推播。',
    push_needs_https: '推播需要 HTTPS（或 localhost）。',
    push_permission_denied: '通知權限遭拒。',
    push_no_service_worker: 'Service worker 無法使用。',
    push_server_unavailable: '伺服器無法提供推播金鑰。',
    push_test_sent: '測試推播已傳送。',
    push_test_failed: '測試推播失敗。',
