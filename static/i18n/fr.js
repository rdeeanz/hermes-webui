...
// ─────────────────────────────────────────────────────────────────────────────
// fr — loaded on demand by the loader in index.html.
LOCALES['fr'] = {
    ...
    settings_label_push: 'Notifications push (fonctionne même app fermée)',
    settings_desc_push: 'Envoie une notification même lorsque le navigateur est fermé — à la fin d’un tour, ou quand l’agent attend votre approbation.',
    push_test_btn: 'Envoyer un test',
    push_ios_hint: 'Sur iPhone et iPad, le push ne fonctionne qu’après avoir ajouté Hermes à l’écran d’accueil — les onglets Safari ne peuvent pas le recevoir.',
    push_active: 'Actif sur cet appareil.',
    push_unsupported: 'Le push n’est pas pris en charge dans ce navigateur.',
    push_needs_https: 'Le push nécessite HTTPS (ou localhost).',
    push_permission_denied: 'Autorisation de notification refusée.',
    push_no_service_worker: 'Service worker indisponible.',
    push_server_unavailable: 'Le serveur n’a pas pu fournir de clé push.',
    push_test_sent: 'Test envoyé.',
    push_test_failed: 'Échec du test push.',
