...
// ─────────────────────────────────────────────────────────────────────────────
// it — loaded on demand by the loader in index.html.
LOCALES['it'] = {
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_label_push: 'Notifiche push (funzionano ad app chiusa)',
    settings_desc_push: 'Invia una notifica anche quando il browser è chiuso — al termine di un turno o quando l’agente attende la tua approvazione.',
    push_test_btn: 'Invia push di prova',
    push_ios_hint: 'Su iPhone e iPad il push funziona solo dopo aver aggiunto Hermes alla schermata Home — le schede di Safari non possono riceverlo.',
    push_active: 'Attivo su questo dispositivo.',
    push_unsupported: 'Il push non è supportato in questo browser.',
    push_needs_https: 'Il push richiede HTTPS (o localhost).',
    push_permission_denied: 'Autorizzazione alle notifiche negata.',
    push_no_service_worker: 'Service worker non disponibile.',
    push_server_unavailable: 'Il server non ha potuto fornire una chiave push.',
    push_test_sent: 'Push di prova inviato.',
    push_test_failed: 'Push di prova non riuscito.',
