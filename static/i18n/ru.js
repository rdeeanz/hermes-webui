...
// ─────────────────────────────────────────────────────────────────────────────
// ru — loaded on demand by the loader in index.html.
LOCALES['ru'] = {
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_push: 'Push-уведомления (работают при закрытом приложении)',
    settings_desc_push: 'Присылает уведомление даже при закрытом браузере — когда ход завершён или когда агент ждёт вашего подтверждения.',
    push_test_btn: 'Отправить тест',
    push_ios_hint: 'На iPhone и iPad push работает только после добавления Hermes на главный экран — вкладки Safari его не получают.',
    push_active: 'Активно на этом устройстве.',
    push_unsupported: 'Этот браузер не поддерживает push.',
    push_needs_https: 'Для push нужен HTTPS (или localhost).',
    push_permission_denied: 'В разрешении на уведомления отказано.',
    push_no_service_worker: 'Service worker недоступен.',
    push_server_unavailable: 'Сервер не смог предоставить ключ push.',
    push_test_sent: 'Тестовое уведомление отправлено.',
    push_test_failed: 'Не удалось отправить тестовое уведомление.',
