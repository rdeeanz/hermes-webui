...
// ─────────────────────────────────────────────────────────────────────────────
// ko — loaded on demand by the loader in index.html.
LOCALES['ko'] = {
    ...
    settings_label_push: '푸시 알림 (앱이 닫혀 있어도 작동)',
    settings_desc_push: '브라우저가 닫혀 있어도 알려줍니다 — 턴이 끝났을 때, 또는 에이전트가 승인을 기다릴 때.',
    push_test_btn: '테스트 푸시 보내기',
    push_ios_hint: 'iPhone과 iPad에서는 Hermes를 홈 화면에 추가한 뒤에만 푸시가 작동합니다 — Safari 탭은 받을 수 없습니다.',
    push_active: '이 기기에서 활성화됨.',
    push_unsupported: '이 브라우저는 푸시를 지원하지 않습니다.',
    push_needs_https: '푸시에는 HTTPS(또는 localhost)가 필요합니다.',
    push_permission_denied: '알림 권한이 거부되었습니다.',
    push_no_service_worker: 'Service worker를 사용할 수 없습니다.',
    push_server_unavailable: '서버가 푸시 키를 제공하지 못했습니다.',
    push_test_sent: '테스트 푸시를 보냈습니다.',
    push_test_failed: '테스트 푸시에 실패했습니다.',
