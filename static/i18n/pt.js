...
// ─────────────────────────────────────────────────────────────────────────────
// pt — loaded on demand by the loader in index.html.
LOCALES['pt'] = {
    ...
    settings_label_push: 'Notificações push (funcionam com o app fechado)',
    settings_desc_push: 'Envia uma notificação mesmo com o navegador fechado — quando um turno termina ou quando o agente aguarda sua aprovação.',
    push_test_btn: 'Enviar push de teste',
    push_ios_hint: 'No iPhone e iPad, o push só funciona depois de adicionar o Hermes à Tela de Início — abas do Safari não podem recebê-lo.',
    push_active: 'Ativo neste dispositivo.',
    push_unsupported: 'Este navegador não suporta push.',
    push_needs_https: 'O push exige HTTPS (ou localhost).',
    push_permission_denied: 'Permissão de notificações negada.',
    push_no_service_worker: 'Service worker indisponível.',
    push_server_unavailable: 'O servidor não pôde fornecer uma chave push.',
    push_test_sent: 'Push de teste enviado.',
    push_test_failed: 'Falha no push de teste.',
