...
// ─────────────────────────────────────────────────────────────────────────────
// es — loaded on demand by the loader in index.html.
LOCALES['es'] = {
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_push: 'Notificaciones push (funcionan con la app cerrada)',
    settings_desc_push: 'Envía una notificación incluso con el navegador cerrado — al terminar un turno o cuando el agente espera tu aprobación.',
    push_test_btn: 'Enviar push de prueba',
    push_ios_hint: 'En iPhone y iPad el push solo funciona tras añadir Hermes a la pantalla de inicio — las pestañas de Safari no pueden recibirlo.',
    push_active: 'Activo en este dispositivo.',
    push_unsupported: 'Este navegador no admite push.',
    push_needs_https: 'El push requiere HTTPS (o localhost).',
    push_permission_denied: 'Permiso de notificaciones denegado.',
    push_no_service_worker: 'Service worker no disponible.',
    push_server_unavailable: 'El servidor no pudo proporcionar una clave push.',
    push_test_sent: 'Push de prueba enviado.',
    push_test_failed: 'Error al enviar el push de prueba.',
