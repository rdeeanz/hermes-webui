...
// ─────────────────────────────────────────────────────────────────────────────
// zh — loaded on demand by the loader in index.html.
LOCALES['zh'] = {
    offline_title: '连接已断开',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_label_push: '推送通知（应用关闭时也能收到）',
    settings_desc_push: '即使浏览器已关闭也会通知你 — 回合完成时，或代理等待你批准时。',
    push_test_btn: '发送测试推送',
    push_ios_hint: '在 iPhone 和 iPad 上，需先将 Hermes 添加到主屏幕，推送才能工作 — Safari 标签页无法接收。',
    push_active: '已在此设备上启用。',
    push_unsupported: '此浏览器不支持推送。',
    push_needs_https: '推送需要 HTTPS（或 localhost）。',
    push_permission_denied: '通知权限被拒绝。',
    push_no_service_worker: 'Service worker 不可用。',
    push_server_unavailable: '服务器无法提供推送密钥。',
    push_test_sent: '测试推送已发送。',
