...
# Locales held to full key parity. Partial bundles (tests/locale_contract.py) may
# also define some of these keys, so the assertions below use `>=`: the invariant
# is that no fully-translated locale is missing one.
LOCALE_COUNT = 15
